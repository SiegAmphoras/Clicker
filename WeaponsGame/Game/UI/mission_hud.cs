...
namespace WeaponsGame.Game.UI
{
	internal class mission_hud
	{
		...
		public void Construct()
		{
			...
			this.grenadeLabel.SetFont(Renderer.GetFont("Test32"));
			...
			this.healthkitLabel.SetFont(Renderer.GetFont("Test32"));
			...
			this.armorButtonLabel.SetFont(Renderer.GetFont("Test32"));
			...
			this.healthLabel.SetFont(Renderer.GetFont("Test32"));
			...
			this.armorLabel.SetFont(Renderer.GetFont("Test32"));
			...
			this.ammoLabel.SetFont(Renderer.GetFont("Test32"));
			...
			this.enemyCounter.SetFont(Renderer.GetFont("Test18"));
